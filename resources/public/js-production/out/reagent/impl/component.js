...
if((i < len)){
var k = (ks[i]);
var G__17293 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__17294 = (i + (1));
m = G__17293;
i = G__17294;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__17298 = c;
var G__17298__$1 = (((G__17298 == null))?null:G__17298.prototype);
if((G__17298__$1 == null)){
return null;
} else {
return (G__17298__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__17302 = c;
var G__17302__$1 = (((G__17302 == null))?null:G__17302.prototype);
if((G__17302__$1 == null)){
return null;
} else {
return (G__17302__$1["render"]);
}
})()));
});
...
return (function() { 
var G__17308__delegate = function (args){
var G__17306 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__17306) : reagent.impl.component.as_element.call(null,G__17306));
};
...
var _STAR_current_component_STAR_17313 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_17313;
}});
...
var G__17321 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__17321) {
...
return ((function (G__17321){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__17324 = reagent.impl.component.state_atom(c);
var G__17325 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__17324,G__17325) : cljs.core.reset_BANG_.call(null,G__17324,G__17325));
});
;})(G__17321))
...
var c = this;
var G__17327_17329 = (c["cljsRatom"]);
if((G__17327_17329 == null)){
} else {
reagent.ratom.dispose_BANG_(G__17327_17329);
}
...
var renders_17332 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_17333 = cljs.core.first(cljs.core.vals(renders_17332));
if((cljs.core.count(renders_17332) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_17332))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_17333)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_17333], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6247__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6247__auto__)){
return or__6247__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6247__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6247__auto__)){
return or__6247__auto__;
} else {
...
var name__$1 = (function (){var G__17331 = name;
switch (G__17331) {
case "":
...
var elem = (function (){var G__17342 = (function (){var or__6247__auto__ = (function (){var G__17344 = c;
if((G__17344 == null)){
return null;
} else {
return (G__17344["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6247__auto__)){
return or__6247__auto__;
...
return (G__17342["_currentElement"]);
}
})();
var name = (function (){var G__17345 = elem;
var G__17345__$1 = (((G__17345 == null))?null:(G__17345["type"]));
if((G__17345__$1 == null)){
return null;
} else {
return (G__17345__$1["displayName"]);
}
})();
var path = (function (){var G__17346 = elem;
var G__17346__$1 = (((G__17346 == null))?null:(G__17346["_owner"]));
var G__17346__$2 = (((G__17346__$1 == null))?null:reagent$impl$component$component_path(G__17346__$1));
if((G__17346__$2 == null)){
return null;
} else {
return [cljs.core.str(G__17346__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6247__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6247__auto__)){
return or__6247__auto__;
} else {
var G__17348 = c;
var G__17348__$1 = (((G__17348 == null))?null:G__17348.constructor);
if((G__17348__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__17348__$1);
}
}
})();
