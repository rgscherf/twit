...
return cljs.core._write(writer__6854__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17378 = o;
(G__17378[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6235__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6235__auto__){
var and__6235__auto____$1 = cljs.core.some_QMARK_(jsprops);
...
var G__17386 = jsprops;
(G__17386["defaultValue"] = value);

(G__17386["onChange"] = ((function (G__17386,v,value,on_change){
return (function (p1__17384_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17384_SHARP_);
});})(G__17386,v,value,on_change))
);
...
var vec__17393 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17393,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17393,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17393,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___17398 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___17398 == null)){
} else {
var key_17399 = temp__4661__auto___17398;
(jsprops["key"] = key_17399);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17401 = (new reagent.impl.template.NativeWrapper());
(G__17401["name"] = c);
...
var G__17403 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17403) : reagent.impl.template.as_element.call(null,G__17403));
} else {
...
var len__7322__auto___17409 = arguments.length;
var i__7323__auto___17410 = (0);
while(true){
if((i__7323__auto___17410 < len__7322__auto___17409)){
args__7329__auto__.push((arguments[i__7323__auto___17410]));

var G__17411 = (i__7323__auto___17410 + (1));
i__7323__auto___17410 = G__17411;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17407){
var G__17408 = cljs.core.first(seq17407);
var seq17407__$1 = cljs.core.next(seq17407);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17408,seq17407__$1);
});
...
break;
default:
var G__17415 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17415;
continue;
...
var n__7162__auto___17418 = a.length;
var i_17419 = (0);
while(true){
if((i_17419 < n__7162__auto___17418)){
(a[i_17419] = reagent.impl.template.as_element((a[i_17419])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7162__auto___17421 = a.length;
var i_17422 = (0);
while(true){
if((i_17422 < n__7162__auto___17421)){
var val_17423 = (a[i_17422]);
if((cljs.core.vector_QMARK_(val_17423)) && ((reagent.impl.template.key_from_vec(val_17423) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17422] = reagent.impl.template.as_element(val_17423));
...
var ctx = {};
var vec__17428 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17428,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17428,(1),null);
...
var G__17432 = (cljs.core.count(argv) - first_child);
switch (G__17432) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17432){
